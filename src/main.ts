...
//加载纹理
const texture:THREE.Texture = new THREE.TextureLoader().load('/public/texture01.jpg')

//设置立方体的颜色
const cubeMaterial:MeshBasicMaterial = new  THREE.MeshBasicMaterial({ color: 0xffff00,map:texture})
// 创建物体
